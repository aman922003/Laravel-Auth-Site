                            ...
                            <article class="article">
                                ...
                                <div class="meta-top">
                                    <ul>
                                        ...
                                        <li class="d-flex align-items-center">
                                            ...
                                            <a href="blog-details.html">{{ $post->comments_count ?? $post->comments()->count() }}
                                                Comments</a>
                                        </li>
                                        <li class="d-flex align-items-center">
                                            <i class="bi bi-heart"></i>
                                            <a href="blog-details.html">{{ $post->likes_count ?? $post->likes()->count() }}
                                                Likes</a>
                                        </li>
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-auto">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!-- Comment Button -->
                                        <a href="#comment-form" class="btn btn-sm btn-outline-primary hover-fill me-2">
                        ...
                        <div class="container">
                            ...
                            <div class="card mb-4 border-start border-4 border-dark bg-white shadow-sm">
                                <div class="card-body">
                                    ...
                                    <div class="card mt-3 ms-4 border-start border-3 border-info bg-light shadow-sm">
